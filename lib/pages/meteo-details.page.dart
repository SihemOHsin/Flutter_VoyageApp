          ...
          return Card(
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [Colors.brown.shade800 ,Colors.transparent ]),
              ),
              child: Row(
                ...
                children: <Widget>[
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(fontSize: 22, fontWeight: FontWeight.w300 ,color: Colors.brown.shade200),
                            ),
                            Text(
                              ...
                              style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold ,color: Colors.brown.shade200),
                            ),
                          ],
                        ),
                      ),
                  ...
                  Text("${(meteoData['list'][index]['main']['temp'] - 273.15).round()} °C", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.brown.shade800)),
                ],
              ),
            ),
          );
