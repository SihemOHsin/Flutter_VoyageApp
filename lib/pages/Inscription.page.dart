          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                  ...
                  child: Text('Inscription', style: TextStyle(fontSize: 22,  color: Colors.brown.shade800))),
            ),
            TextButton(
                child: Text("J'ai déjà un compte", style: TextStyle(fontSize: 22,  color: Colors.brown.shade800)),
                onPressed: () {
