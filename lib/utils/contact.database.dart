...
abstract class ContactDatabase {
  ...
  static Future<void> initDB() async {
    ...
    String _path = join (databasePath, 'voyage_app.db');
...
//Méthode de modification d'un contact
  static Future<int> modifier (Contact contact) async { await getdb();
  return _db!.update (Contact.table, contact.toJson(), where: 'id = ?', whereArgs: [contact.id]);
  }
//Méthode de suppression d'un contact
  static Future<int> supprimer (Contact contact) async { await getdb();
